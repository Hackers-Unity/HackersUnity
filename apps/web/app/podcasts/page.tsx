        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              {/* Category Pill */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.05] border border-white/10 text-xs font-bold text-slate-300 backdrop-blur-md">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-[1.15]">
                Voices that <span className="text-white">matter</span>,{' '}
                <span className="bg-gradient-to-r from-[#0099e6] via-sky-300 to-amber-300 bg-clip-text text-transparent">
              ...
              <div className="pt-4 border-t border-white/[0.08] flex flex-wrap items-center gap-4 sm:gap-6 text-xs text-slate-400">
                {/* Avatar stack */}
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    <div className="w-7 h-7 rounded-full border-2 border-[#0c1220] overflow-hidden bg-slate-800">
                    ...
                    <div className="w-7 h-7 rounded-full border-2 border-[#0c1220] overflow-hidden bg-[#0099e6] text-white text-[9px] font-black flex items-center justify-center">
                      50K+
                    </div>
                  </div>
                  <span className="font-semibold text-slate-300">
                    <strong className="text-white">50K+ Listeners</strong> streaming on Hacker&apos;s Unity
                  </span>
                </div>
            ...
            <div className="lg:col-span-5 flex justify-center lg:justify-end">
              <div className="w-full max-w-sm rounded-3xl p-4 sm:p-5 bg-gradient-to-b from-[#131b2e] to-[#0a0f1d] border border-white/10 shadow-2xl shadow-black/80 hover:border-[#0099e6]/50 transition-all duration-300 group">
                {/* Image Container */}
                <div className="relative aspect-[4/3] w-full rounded-2xl overflow-hidden bg-slate-900 border border-white/10 mb-4">
                  <Image
                  ...
                  <div className="absolute bottom-3 left-3">
                    <span className="px-2.5 py-1 rounded-md bg-amber-500/80 backdrop-blur-md text-black font-extrabold text-[10px] tracking-wider uppercase">
                      STARTUP &amp; BIG TECH
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-white line-clamp-2 leading-snug group-hover:text-[#0099e6] transition-colors">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-9 py-2.5 rounded-full bg-white/[0.05] border border-white/10 text-white placeholder-slate-400 text-xs focus:outline-none focus:border-[#0099e6] focus:ring-1 focus:ring-[#0099e6] transition-colors"
            />
            {searchQuery && (
              <button
                type="button"
        ...
        {filteredEpisodes.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {filteredEpisodes.map((ep) => (
              <div
                key={ep.id}
                className="group rounded-3xl bg-[#0b101b] border border-white/[0.08] hover:border-[#0099e6]/60 shadow-xl transition-all duration-300 flex flex-col overflow-hidden hover:-translate-y-1"
              >
                {/* Card Thumbnail Area */}
                ...
                <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-4">
                  <div className="space-y-2">
                    <h3 className="text-sm sm:text-base font-bold text-white line-clamp-2 leading-snug group-hover:text-[#0099e6] transition-colors">
                      {ep.title}
                    </h3>
