...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    id: 'blog-robotics-embodied-ai',
    slug: 'next-gen-robotics-embodied-ai-real-time-motor-control-ros2',
    title: 'Next-Gen Robotics & Embodied AI: Real-Time Motor Control & ROS 2',
    subtitle: 'From sim-to-real reinforcement learning to microsecond hardware actuation in autonomous robotics.',
    excerpt: 'Explore how embodied AI models and ROS 2 enable humanoid balance, precision manipulator control, and real-time sensor fusion.',
    category: 'Robotics',
    image: '/blogs/iot.jpg',
    publishedAt: 'Aug 25, 2026',
    readTime: '5 min read',
    tags: ['Robotics', 'Embodied AI', 'ROS 2', 'Hardware', 'Actuators'],
    featured: false,
    coverGradient: 'from-emerald-600/30 via-teal-600/20 to-slate-950/40',
    content: [
      'The convergence of large multimodal models and physical robotics has given birth to **Embodied AI**. Modern robots no longer follow rigid hardcoded path routines; they perceive dynamic physical spaces, reason about object affordances, and execute adaptive physical interactions in real-time.',
      '### The Sim-to-Real Challenge',
      'Training physical robots in the real world is dangerously slow and expensive. State-of-the-art labs train reinforcement learning policies inside physics simulators (NVIDIA Isaac Sim, MuJoCo) across millions of parallel virtual environments before zero-shot transfer onto real robot arms and humanoids.',
      '### ROS 2 & Micro-ROS Architecture',
      'ROS 2 (Robot Operating System 2) delivers the deterministic, real-time publish-subscribe communication backbone (DDS) required for sub-millisecond motor actuation loops, tactile sensor feedback, and SLAM navigation pipelines.',
    ],
  },
  {
    id: 'blog-opensource-community-engine',
    slug: 'open-source-engine-architecting-high-velocity-community-codebases',
    title: 'The Open Source Engine: Architecting High-Velocity Community Codebases',
    subtitle: 'How global engineering communities maintain zero-debt repositories, manage RFCs, and scale contributor pipelines.',
    excerpt: 'Building sustainable open source projects that power modern infrastructure. Learn governance models, automated triage, and community flywheel mechanics.',
    category: 'Open Source',
    image: '/blogs/cloud.jpg',
    publishedAt: 'Aug 20, 2026',
    readTime: '6 min read',
    tags: ['Open Source', 'GitHub', 'Architecture', 'Community', 'DevRel'],
    featured: false,
    coverGradient: 'from-violet-600/30 via-purple-600/20 to-slate-950/40',
    content: [
      'Open source software underpins over 95% of the modern software stack. However, the difference between an abandoned side project and a vibrant global standard lies in intentional engineering governance.',
      '### The RFC (Request for Comments) Lifecycle',
      'To prevent architectural drift, successful OSS projects utilize an RFC process. Before writing large features, contributors submit lightweight markdown design proposals covering API ergonomics, backward compatibility, and performance trade-offs.',
      '### Automated CI Bot Triage & Developer Experience',
      'Leveraging GitHub Actions and bot triage to automatically label issues, check CLA signatures, and provide instant preview deployments reduces maintainer burnout and empowers first-time contributors.',
    ],
  },
  {
    id: 'blog-spatial-computing-webxr',
    slug: 'spatial-computing-webxr-building-interactive-3d-realities',
    title: 'Spatial Computing & WebXR: Building Interactive 3D Realities in Production',
    subtitle: 'Real-time shader pipelines, hand-tracking kinematics, and the next frontier of immersive computing interfaces.',
    excerpt: 'Ditch flat 2D viewports. Discover how WebXR, Three.js, and spatial anchors enable immersive collaborative workspaces and developer tools.',
    category: 'AR / VR & Spatial',
    image: '/blogs/web3.jpg',
    publishedAt: 'Aug 15, 2026',
    readTime: '7 min read',
    tags: ['AR / VR & Spatial', 'Spatial Computing', 'WebXR', 'Three.js', 'Metaverse'],
    featured: false,
    coverGradient: 'from-fuchsia-600/30 via-pink-600/20 to-purple-950/40',
    content: [
      'Spatial computing represents the largest shift in human-computer interaction since the multi-touch smartphone. With devices like Apple Vision Pro and Meta Quest 3, the browser canvas expands from a rectangular window into infinite 3D space.',
      '### WebXR Device API Fundamentals',
      'The WebXR Device API provides standard browser access to 6DoF (Six Degrees of Freedom) head tracking, hand joint skeletons, and stereoscopic rendering hardware without requiring native app installs.',
      '### Optimizing 3D Web Performance',
      'Rendering at 90 frames per second per eye requires extreme discipline: draw call batching, texture compression (KTX2 / Basis Universal), and offloading physics simulations to Web Workers via SharedArrayBuffer.',
    ],
  },
];
